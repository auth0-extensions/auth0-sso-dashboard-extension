...
// Fetch authz status.
export const FETCH_AUTHZ_STATUS = 'FETCH_AUTHZ_STATUS';
export const FETCH_AUTHZ_STATUS_PENDING = 'FETCH_AUTHZ_STATUS_PENDING';
export const FETCH_AUTHZ_STATUS_REJECTED = 'FETCH_AUTHZ_STATUS_REJECTED';
export const FETCH_AUTHZ_STATUS_FULFILLED = 'FETCH_AUTHZ_STATUS_FULFILLED';

// Fetch update authz.
export const UPDATE_AUTHZ_STATUS = 'UPDATE_AUTHZ_STATUS';
export const UPDATE_AUTHZ_STATUS_PENDING = 'UPDATE_AUTHZ_STATUS_PENDING';
export const UPDATE_AUTHZ_STATUS_REJECTED = 'UPDATE_AUTHZ_STATUS_REJECTED';
export const UPDATE_AUTHZ_STATUS_FULFILLED = 'UPDATE_AUTHZ_STATUS_FULFILLED';
